...
public class MoneyUtil {
    ...
    public static BigDecimal setScaleMyself(BigDecimal bigDecimal) {
    ...
    /**
     *
     * @param bigDecimal  0.5
     * @return  50.00%
     */
    public static String getProgress(double bigDecimal) {
        DecimalFormat df = new DecimalFormat("######0.00");
        return df.format(bigDecimal * 100) + "%";
    }
